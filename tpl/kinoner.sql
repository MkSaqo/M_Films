...
CREATE TABLE `kinoner` (
  ...
  `desc1` varchar(50) CHARACTER SET utf8 NOT NULL,
  ...
  `glavnin0` varchar(122) CHARACTER SET utf8 NOT NULL,
  `glavnin1` varchar(50) CHARACTER SET utf8 NOT NULL,
  `glavnin2` varchar(50) CHARACTER SET utf8 NOT NULL,
  `glavnin3` varchar(50) CHARACTER SET utf8 NOT NULL,
  `glavnin4` varchar(50) CHARACTER SET utf8 NOT NULL,
